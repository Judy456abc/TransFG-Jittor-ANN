...
# from jittor.utils.misc import download_url_to_local as download_url, check_integrity, extract_tar as extract_archive
...
# ------------------------------------------------
class CUB(Dataset):
    def __init__(self, root, is_train=True, data_len=None, transform=None, batch_size=None):
...
class CarsDataset(Dataset):
    ...
    def __init__(self, mat_anno, data_dir, car_names, cleaned=None, transform=None):
        ...
        # self.total_len = len(self.car_annotations)
    ...
    def __getitem__(self, idx):
        ...
        # car_class = jt.array(np.array(car_class.astype(np.float32))).float32() - jt.ones(1).float32()
        # car_class = jt.array(np.array(car_class.astype(np.float32))).int32() - 1
        car_class = car_class.astype(np.int32) - 1
...
class dogs(Dataset):
    ...
    def __init__(self,
        ...
        self.total_len = len(self._flat_breed_images)
